...
export class AddFinancialManagement1775478651623 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."budget_lines_category_enum" AS ENUM('Direct Cash Transfers', 'Skills Training Programs', 'Agricultural Support', 'Administrative Costs', 'Healthcare Services', 'Infrastructure Development', 'Emergency Relief', 'Education Programs', 'Other')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."disbursements_status_enum" AS ENUM('Pending', 'Processing', 'Paid', 'Failed')`,
    );
    await queryRunner.query(
      `CREATE TABLE "disbursements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "batch_number" character varying(50) NOT NULL, "amount" numeric(15,2) NOT NULL, "status" "public"."disbursements_status_enum" NOT NULL DEFAULT 'Paid', "payment_date" TIMESTAMP, "bank_name" character varying(100), "account_number" character varying(50), "reference_number" character varying(100), "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "intervention_id" uuid NOT NULL, "beneficiary_id" uuid NOT NULL, "approved_by" uuid, "created_by" uuid NOT NULL, CONSTRAINT "PK_2f9ea0e5b8382113aaa3e51cdfa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "budget_lines" ADD CONSTRAINT "FK_211332b2e06301392224b1c75bd" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "disbursements" ADD CONSTRAINT "FK_533a3050be5ff27c2b3b724d830" FOREIGN KEY ("intervention_id") REFERENCES "interventions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "disbursements" ADD CONSTRAINT "FK_11b3d8e0457a5535e274d4d6d03" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "disbursements" DROP CONSTRAINT "FK_11b3d8e0457a5535e274d4d6d03"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "disbursements" DROP CONSTRAINT "FK_533a3050be5ff27c2b3b724d830"`,
    );
    await queryRunner.query(
      `ALTER TABLE "budget_lines" DROP CONSTRAINT "FK_211332b2e06301392224b1c75bd"`,
    );
